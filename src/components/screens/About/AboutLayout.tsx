...
const AboutLayout: FC<{ activeIndex: number; children: ReactNode }> = ({ activeIndex, children }) => {
  return (
    <div className='mx-auto mb-20 flex h-full w-10/12 flex-col gap-x-8 gap-y-12 pt-36 lg:flex-row lg:gap-x-24'>
      <div className='w-full min-w-[15rem] lg:w-4/12 xl:w-3/12'>
