...
var SecondSection = function () {
    return (React.createElement("div", { className: 'relative flex h-[600px] ' },
        React.createElement("div", { className: 'absolute bottom-[0px] h-[650px] w-1/2 bg-home-bg object-fill', style: {
